...
export const CSV_COLUMNS = [
  ...
  'total_vectors',
  'calibration_status',
  'lateral_profile_flow_m3s',
  'lateral_profile_columns_used',
...
export function measurementRow(measurement: SavedMeasurement): Record<CsvColumn, string | number | null> {
  ...
  return {
    ...
    lateral_profile_flow_m3s: measurement.lateralProfileFlowM3s ?? null,
    lateral_profile_columns_used: measurement.lateralProfileColumnsUsed ?? null,
